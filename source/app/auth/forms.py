...
class RegistrationForm(Form):
	...
	username = StringField('User Name', validators = [Required(), Length(1,64), Regexp('^[A-Za-z][A-Za-z0-9_.]*$', 0, 'Usernames must have\ 		only letters, ''numbers, dots or underscores')])
